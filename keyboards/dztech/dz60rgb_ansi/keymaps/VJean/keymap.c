...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_ansi(
        ...
        LCTL_T(KC_GRV), KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, MO(1),   MO(2),   RCTL_T(KC_GRV)
    ),
    [1] = LAYOUT_60_ansi(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,  KC_F12,  KC_DEL,
        _______, KC_PGUP, KC_UP,   KC_PGDN,  KC_HOME, _______, _______, KC_PGUP, KC_UP,   KC_PGDN,  KC_HOME, KC_SLCK, _______, RESET,
        _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,  _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,  _______,          _______,
